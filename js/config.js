const context  = {
	...
	"maxlab": {
		...
		"beschreibung":             "Das Angebot des MaxLabs richtet sich primär an Schülergruppen aus der Oberstufe, jedoch können auch Gruppen aus Unter- und Mittelstufe das Schülerlabor besuchen. Die Kurse sind kostenfrei und bieten den Teilnehmern die Möglichkeit, sich in verschiedenen Teilgebieten der Biologie zu vertiefen und praktische Erfahrungen zu sammeln. Zu einem festen Termin können Schüler einmal jährlich ein Schülerpraktikum absolvieren. Klassen der gymnasialen Oberstufe können im Verbund ein Online PCR Escape-Game spielen, um ihr Wissen der Themengebiete Genetik, Proteinbiosynthese und Mutation auf die Probe zu stellen.<br>Darüber hinaus besteht die Möglichkeit, an virtuellen Unterrichtsstunden zu den Themen 'Faszination Gehirn' und 'Vom genetischen Code zum Proteom' teilzunehmen.",
	...
	"eso-supernova": {
		...
		"überthema":                ["Physik"],
		"unterthema":               ["Astrophysik","Sterne", "Palneten", "Teleskope"],
...
,
	...
	"Genetik macht Schule": {
		...
		"öffnungszeiten_ausnahmen": "Die Schülerlabortage finden in den Wochen nach den Pfingstferien statt. Bitte wenden Sie sich an die <a href='https://teaching.genetik.biologie.uni-muenchen.de/teaching/kurse/genetik-macht-schule'>Webseite des Schülerlabors</a> für die jeweils aktuellen Termine.",
		"bildquellen": "Eigenaufnahmen",
	...
	"MINT Campus Dachau": {
		...
		"unterthema":               ["Programmieren","Arduino", "EV3", "Calliope", "3D-Druck", "Löten", "Holzwerkstatt"],
		"zielgruppe":               5,
